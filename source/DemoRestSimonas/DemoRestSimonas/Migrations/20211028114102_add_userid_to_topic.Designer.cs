...
namespace DemoRestSimonas.Migrations
{
    ...
    [Migration("20211028114102_add_userid_to_topic")]
    partial class add_userid_to_topic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoRestSimonas.Data.Dtos.Auth.DemoRestUser", b =>
                {
            ...
            modelBuilder.Entity("DemoRestSimonas.Data.Entities.Topic", b =>
                {
                    b.HasOne("DemoRestSimonas.Data.Dtos.Auth.DemoRestUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DemoRestSimonas.Data.Dtos.Auth.DemoRestUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
