...
namespace DemoRestSimonas.Migrations
{
    ...
    [Migration("20221101154719_postgresql")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoRestSimonas.Auth.Model.ForumRestUser", b =>
                {
            ...
            modelBuilder.Entity("DemoRestSimonas.Data.Entities.Topic", b =>
                {
                    b.HasOne("DemoRestSimonas.Auth.Model.ForumRestUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DemoRestSimonas.Auth.Model.ForumRestUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
